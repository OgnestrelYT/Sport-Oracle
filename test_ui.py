...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Main_Table.horizontalHeader().setDefaultSectionSize(240)
        ...
        self.Create_New_File_Button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.Create_New_File_Button.setEnabled(True)
        self.Create_New_File_Button.setObjectName("Create_New_File_Button")
        self.verticalLayout.addWidget(self.Create_New_File_Button)
        self.Sessions_Table_Button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.Sessions_Table_Button.setObjectName("Sessions_Table_Button")
        self.verticalLayout.addWidget(self.Sessions_Table_Button)
        ...
        self.Update_Table.setGeometry(QtCore.QRect(470, 520, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Create_New_File_Button.setText(_translate("MainWindow", "Создать"))
        self.Sessions_Table_Button.setText(_translate("MainWindow", "Расписание сессий"))
        self.Save_Table_Button.setText(_translate("MainWindow", "Сохранить"))
        self.Load_Table_Button.setText(_translate("MainWindow", "Загрузить базу данных"))
        self.New_Row.setText(_translate("MainWindow", "Новая строчка"))
        self.Remove_Row.setText(_translate("MainWindow", "Удалить строчку"))
        self.Update_Table.setText(_translate("MainWindow", "Добавить новый учебный год"))
